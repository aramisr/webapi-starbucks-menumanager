...
namespace Core.Mappy
{
    public class Mapper : IMapper
    {
        ...
        private TDestination MapCollection<TDestination>(object source)
        {
            ...
            //Obtenemos la configuracion para el mapeo de elementos individuales
            ...
            var hasElementConfig =
                _configurations.TryGetValue(elementMappingKey, out var elementConfig);
